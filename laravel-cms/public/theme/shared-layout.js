(() => {
  ...
  const assetBase = "/theme/";
  const sharedLogo = `${assetBase}logoMenuRight1.png`;
  const sharedFooterLogo = `${assetBase}logofooter.png`;
  const contact = {
  ...
  const desktopLinksHtml = desktopNavLinks
    .map((link) => {
      ...
      <a class="header-nav__link header-nav__link--home" href="${link.href}" data-page-key="${link.key}">
        <img src="${assetBase}assets/icons/icon-home.webp" alt="">
    ...
    <footer class="site-footer">
      ...
      <div class="footer-grid">
        <article class="footer-item">
          <img src="${assetBase}assets/icons/icon-footer-1.webp" alt="">
          <p>${contact.address}</p>
        </article>
        <article class="footer-item">
          <img src="${assetBase}assets/icons/icon-footer-2.webp" alt="">
          <p><a href="${contact.websiteHref}" target="_blank" rel="noreferrer noopener">${contact.websiteLabel}</a></p>
        </article>
        <article class="footer-item">
          <img src="${assetBase}assets/icons/icon-footer-3.webp" alt="">
          <p><a href="${contact.emailHref}">${contact.email}</a></p>
        </article>
        <article class="footer-item">
          <img src="${assetBase}assets/icons/icon-footer-4.webp" alt="">
